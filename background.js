...
copyArea.style.top = '-999px';
copyArea.style.position = 'absolute';
document.body.insertBefore(copyArea, document.body.firstChild);
...
let observer = new MutationObserver(function (mutations) {
  ...
  button.classList.add('casenine_button');
  ...
  button.addEventListener('click', event => {
    copyArea.value = name + ' [Delivers #' + id + ']';
